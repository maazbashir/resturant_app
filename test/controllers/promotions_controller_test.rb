...
class PromotionsControllerTest < ActionDispatch::IntegrationTest
  ...
  test "should create promotion" do
    assert_difference("Promotion.count") do
      post promotions_url, params: { promotion: { code: @promotion.code, discount_per: @promotion.discount_per } }
    end
  ...
  test "should update promotion" do
    patch promotion_url(@promotion), params: { promotion: { code: @promotion.code, discount_per: @promotion.discount_per } }
